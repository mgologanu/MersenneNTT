...
module tb_mrsn_omega32_3_p13;
  ...
  always @(posedge clk) begin
    $display("[%0t]  Input: %0d Prod C: %0d Expected: %0d, Prod S: %0d Expected: %0d  Error: %0d %0d", $time, a_q, a_c, expected_a_c_q, a_s, expected_a_s_q, $signed(a_c-expected_a_c_q), $signed(a_s-expected_a_s_q)) ;
  end
