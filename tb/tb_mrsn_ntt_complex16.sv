module tb_mrsn_ntt_complex16;
   ...
   logic [WIDTH-1:0] a_re[LEN-1:0];
   
   logic [WIDTH-1:0] a_im[LEN-1:0];
   
   logic [WIDTH-1:0] c_re[LEN-1:0];
   
   logic [WIDTH-1:0] c_im[LEN-1:0];
   
   
   logic [WIDTH-1:0] x_re_array [0:3][LEN-1:0];
   logic [WIDTH-1:0] x_im_array [0:3][LEN-1:0];
