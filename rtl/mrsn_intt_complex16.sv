...
module mrsn_intt_complex16 #(
    ...
    input  logic             rst_ni,
    input  logic             en_i,
    input  logic [WIDTH-1:0] a_re_i[0 : LEN - 1],
    input  logic [WIDTH-1:0] a_im_i[0 : LEN - 1],
    output logic [WIDTH-1:0] c_re_o[0 : LEN - 1],
    output logic [WIDTH-1:0] c_im_o[0 : LEN - 1]
);
